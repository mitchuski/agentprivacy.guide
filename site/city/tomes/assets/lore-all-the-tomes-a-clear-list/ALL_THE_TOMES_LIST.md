...
| **IX** | **Open** (opened 2026-06-09) | **8 acts (and growing)** | **The Horizon** | **The Horizon District at V35 · Eos 🌅 / Dokimé 🪨 / Poros 🛤️ · the ecdsa.fail dawn measured · post-quantum durability as measurement, not attack · Act 6 (Draft v1): the dual-agent harness rendered as the rite-in-common at the Hall (V15) · Act 7 (DRAFT, v1.9.2 patch): the Loomkeeper's Weave — the overlay lane reads the research corpus whole; the Loomkeeper a draft persona, not yet cast · Act 8 (Draft v2): the three workings — the field-guide fold, the Lexon grammar campaign at the Forge(t) (coverage-debt 211 → 64), the privacy-pools circuits assayed at the touchstone; mana pools named as INTENT, the gift before the deployment** |
| **X** | **Open** (opened 2026-07-01) | **2 acts (and growing)** | **The Hearth** | **The House of Archon answers · the PVM built on Archon `did:cid` · Warden 🛡️ ⊥ Witness 👁️ under the Sovereign 🔑 · the 7th Capital made liquid (Hearthold). Act 2 (v0.11.0): the Warden gains memory (Recall), the Mage a public face (the Knowledge Portal · public Mage ⊥ private Warden, scaled to a guild), the step-up ladder made whole (factor-2 out-of-band)** |
